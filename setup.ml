       ...
       [
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [
                      (OASISExpr.EBool true,
                        ("$test_loader", ["-pluginloader"; "$pluginloader"]))
                   ];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("main_userconf",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_userconf", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              })
       ];
            ...
            [
                  ...
                  },
                   {
                      ...
                      bs_install =
                        [
                           ...
                           (OASISExpr.EFlag "libraries", true)
                        ];
                      bs_path = "src/oasis";
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("odn",
                               Some (OASISVersion.VGreaterEqual "0.0.11"))
                        ];
                      bs_build_tools =
                        [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "fake_ocamlfind.ml"});
               Executable
                 ({
                     cs_name = "test";
                     cs_data = PropList.Data.create ();
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for OASIS";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "git://github.com/gildor478/oasis.git";
                      src_repo_browser =
                        Some "https://github.com/gildor478/oasis";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/ext/plugin-loader/src";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ...
                           ExternalTool "ocamlmod";
                           InternalExecutable "fake_ocamlfind"
                        ]
                   });
               Library
                 ({
                     cs_name = "pluginloaderLib";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path =
                        "src/ext/plugin-loader/test/data/findlib/plugin1";
                      bs_compiled_object = Best;
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "pluginloaderLib";
                           InternalLibrary "plugin1"
                        ];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "make"];
                      bs_c_sources = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "src/ext/plugin-loader/test/data";
                      bs_compiled_object = Byte;
                      bs_build_depends =
                        [
                           InternalLibrary "pluginloaderLib";
                   ...
                   {exec_custom = false; exec_main_is = "pluginloader.ml"});
               Executable
                 ({
                     cs_name = "test_loader";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "src/ext/plugin-loader/test";
                      bs_compiled_object = Byte;
                      bs_build_depends =
                        [
                           InternalLibrary "plugin-loader";
                   ...
                   {exec_custom = false; exec_main_is = "TestLoader.ml"});
               Test
                 ({
                     cs_name = "main_loader";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ...
                           InternalExecutable "pluginloader"
                        ]
                   });
               Library
                 ({
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "src/ext/userconf/test";
                      bs_compiled_object = Byte;
                      bs_build_depends =
                        [
                           InternalLibrary "userconf";
                           FindlibPackage ("oUnit", None)
                        ];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "make"];
                   ...
                   {exec_custom = false; exec_main_is = "TestUserConf.ml"});
               Test
                 ({
                     cs_name = "main_userconf";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      test_tools =
                        [
                           ExternalTool "ocamlbuild";
                           ExternalTool "make";
                           InternalExecutable "test_userconf"
                        ]
                   })
            ];
          plugins =
